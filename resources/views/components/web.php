...
Route::get('/', function () {
    return view('dashboard-employee', ['type_menu' => 'dashboard']);
});
...
Route::prefix('karyawan')->group(function () {
    ...
    Route::get('/daily-activities-report', function () {
        return view('karyawan/daily-activities-report', ['type_menu' => 'daily-activities-report']);
    })->name('daily-activities-report');
...
Route::prefix('pm')->group(function () {
    ...
    Route::get('/leave-details-pm', function () {
    ...
    Route::get('/daily-activity-report', function () {
        return view('pm.print-pm-daily-activity-report', ['type_menu' => 'print-pm-daily-activity-report']);
    ...
    Route::get('/profile-pm', function () {
        return view('pm/profile', ['type_menu' => 'profile-pm']);
    })->name('profile-pm');

    Route::get('/edit-profile-hrd', function () {
...
Route::prefix('hrd')->group(function () {
    ...
    Route::get('/profile-hrd', function () {
    ...
    Route::get('/print-daily-activity-report', function () {
        return view('hrd.print-daily-activity-report', ['type_menu' => 'print-daily-activity-report']);
    })->name('print-daily-activity-report-hrd');
...
Route::prefix('director')->group(function () {
    ...
    // Route::get('/project-daily-activity', function () {
    //     return view('direktur/project-daily-activity', ['type_menu' => 'project-daily-activity']);
    // })->name('project-daily-activity');
    ...
    Route::get('/print-daily-activity-report', function () {
        return view('direktur/print-daily-activity-report', ['type_menu' => 'print-daily-activity-report-director']);
    })->name('print-daily-activity-report-director');
    ...
    // Route::get('/edit-employment-contract', function () {
    //     return view('direktur/edit-employment-contract', ['type_menu' => 'employment-contract']);
    // })->name('edit-employment-contract');
    ...
    Route::get('/data-master-payslip', function () {
        return view('direktur/data-payrolls', ['type_menu' => 'data-master-payslip']);
