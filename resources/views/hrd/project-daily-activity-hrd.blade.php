...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('css/hrd/project-daily-activity-hrd.css') }}">
@endpush
                    ...
                    <div class="col-12">
                        <div class="project-grid">
                            <div class="project-card">
                                <div class="project-header-hrd">
                                    <h3 class="project-title-hrd">1. Nama Projek</h3>
                                ...
                                <div class="project-content">
                                    <div class="project-info">
                                        ...
                                        <div class="info-row">
                                            <span class="info-label">Progress Projek :</span>
                                    ...
                                    <div class="project-footer">
                                        <a href="{{ route('project-daily-activity-details-hrd') }}"
                            ...
                            <div class="project-card">
                                <div class="project-header-hrd">
                                    <h3 class="project-title-hrd">2. Nama Projek</h3>
                                    <div class="deadline-section">
                                        <span class="deadline-label">deadline projek</span>
                                    </div>
                                </div>
