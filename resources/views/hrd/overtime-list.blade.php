                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            {{-- <tr class="overtime-data text-center">
                                                ...
                                                <td>
                                                    <a href="#" class="evidence" style="text-decoration: none" onclick="openFotoModal()">Buka
                                                        foto</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="overtime-data text-center">
                                                ...
                                                <td>
                                                    <span class="badge badge-pill badge-warning badge-custom" data-toggle="modal" data-target="#trackingStatus1">Menunggu</span>
                                                </td>
                                            </tr>
                                            <tr class="overtime-data text-center">
                                                <td>2</td>
                                                ...
                                                <td>
                                                    <span class="badge badge-pill badge-success badge-custom" data-toggle="modal" data-target="#trackingStatus2">Disetujui</span>
                                                </td>
                                            </tr>
                                            <tr class="overtime-data text-center">
                                                <td>3</td>
