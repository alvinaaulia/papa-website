...
@push('style')
    <link rel="stylesheet" href="{{ asset('css/hrd/daily-activity-report.css') }}">
    <style>
        .form-label {
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title-print-report-hrd">Laporan kegiatan harian</h2>
                <p class="section-lead-print-report-hrd">Laporan kegiatan harian kamu</p>

                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('daily-activity-report-hrd') }}" method="GET">
                            <div class="row mb-3">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('pdf-daily-activity-hrd') }}" target="_blank" class="btn btn-filter me-2">
                                    Cetak
