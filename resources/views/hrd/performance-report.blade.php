...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('css/hrd/performance-report.css') }}">
@endpush
        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h2 class="title-report-hrd">Laporan Kinerja HRD</h2>
                        <p class="subtitle-report-hrd">Daftar Laporan Kinerja</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
