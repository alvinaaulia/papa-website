...
@push('style')
    <link rel="stylesheet" href="{{ asset('css/hrd/presence-recap.css') }}">
    <style>
        .form-label {
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="presence-recap-hrd-title">Laporan Rekap Absensi</h2>
                <p class="presence-recap-hrd-subtitle">Laporan rekap absensi karyawan</p>
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('pdf-presence-hrd') }}" method="GET" target="_blank">
                            <div class="presence-recap-form-row">
                                <div class="presence-recap-form-group">
                                    <label for="nama_karyawan" class="presence-recap-label fw-semibold">Nama
                                        Karyawan</label>
                                    <select name="presenceEmployee[]" id="presenceEmployee"
