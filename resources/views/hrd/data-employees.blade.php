                                            ...
                                            <tr class="text-center overtime-data">
                                                ...
                                                <td>
                                                    <div class="overtime-action space-td">
                                                        <a href="{{ route('edit-employee-details-hrd') }}"
                                                            class="overtime-action" style="text-decoration: none">
                                                            <button type="button" class="btn btn-secondary">Edit</button>
                                                        </a>
                                                        <a href="#" class="overtime-action"
                                                            style="text-decoration: none">
                                                            <button type="button" class="btn btn-danger" onclick="openDeleteModal()">Hapus</button>
                                                        </a>
                                                        <a href="{{ route('employee-details') }}" class="overtime-action" style="text-decoration: none">
                                            ...
                                            <tr class="text-center overtime-data">
                                                ...
                                                <td>
                                                    <div class="overtime-action space-td">
                                                        ...
                                                        <a href="{{ route('employee-details') }}" class="overtime-action">
                                                            <button type="button" class="btn btn-primary">Rincian</button>
                                                        </a>
                                                    </div>
                                                </td>
