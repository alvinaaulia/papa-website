                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-employee">
                                                <label>Jabatan</label>
                                                <input type="text" class="form-control"  value="HRD" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-employee">
                            ...
                            <div class="leave-button">
                                <a href="{{ route('leave-histories-hrd') }}" class="btn btn-light">Kembali</a>
                                <a href="{{ route('leave-histories-hrd') }}" class="btn btn-danger">Simpan Perubahan</a>
                            </div>
                        </form>
                    </div>
                </div>
