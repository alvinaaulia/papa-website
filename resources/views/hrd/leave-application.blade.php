                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-employee">
                                                ...
                                                <textarea class="form-control" name="alamat_cuti" style="height: 100px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-employee">
                                                <label style="font-weight: bold">Telepon*</label>
                                                <input type="telp" class="form-control"
                                                    style="background-color: #fff">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="leave-button">
                                <a href="{{ route('leave-histories-hrd') }}" class="btn btn-light">Simpan Draft</a>
                                <a href="{{ route('leave-histories-hrd') }}" class="btn btn-danger">Ajukan Cuti</a>
                            </div>
                        </form>
                    </div>
                </div>
