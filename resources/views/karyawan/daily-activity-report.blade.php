...
@push('style')
    <link rel="stylesheet" href="{{ asset('css/daily-activity-report.css') }}">
    <style>
        .form-label {
                    ...
                    <div class="card-body">
                        <form action="{{ route('daily-activity-report-pm') }}" method="GET">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('pdf-daily-activity-pm') }}" class="btn btn-filter" target="_blank" style="border-radius: 20px">
...
@push('scripts')
    <script>
        $('#ctivityEmployee').select2({
            width: '100%',
            placeholder: 'Pilih Kategori',
            allowClear: true,
            dropdownParent: $('#addActivityModal')
        });
        $('#ctivityProject').select2({
            width: '100%',
            placeholder: 'Pilih Kategori',
            allowClear: true,
            dropdownParent: $('#addActivityModal')
    ...
    <script src="{{ asset('library/chart.js/dist/Chart.min.js') }}"></scrip>
