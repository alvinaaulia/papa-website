            ...
            <div class="section-body">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p class="section-lead-daily-activities">Rincian Kegiatan Harianmu Ada Disini!</p>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0 justify-content-between">
                    ...
                    <a href="{{ route('pdf-daily-activity-karyawan') }}" class="btn btn-info me-2" target="_blank" style="width: 120px">
