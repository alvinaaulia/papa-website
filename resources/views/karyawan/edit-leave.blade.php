        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('leave-histories') }}">Riwayat Cuti</a></div>
                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                            ...
                            <div class="leave-button">
                                <a href="{{ route('leave-histories') }}" class="btn btn-light">Kembali</a>
                                <a href="{{ route('leave-histories') }}" class="btn btn-danger">Simpan Perubahan</a>
                            </div>
                        </form>
                    </div>
                </div>
