                            ...
                            <div class="card-body">
                                <div class="table">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="width: 5%">No.
                                                </th>
                                                <th class="text-center" style="width: 20%">Nama
                                                </th>
                                                <th class="text-center">Detail</th>
                                                <th class="text-center" style="width: 20%">Status
                                                </th>
                                                <th class="text-center" style="width: 10%">Aksi
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <div class="overtime-action">
                                                            <a href="{{ route('edit-leave') }}" class="overtime-action"
