        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('overtime-histories') }}">Riwayat Lembur</a></div>
                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                            ...
                            <div class="overtime-button">
                                <a href="{{ route('overtime-histories') }}" class="btn btn-light">Kembali</a>
                                <a href="{{ route('overtime-histories') }}" class="btn btn-danger">Simpan Perubahan</a>
                            </div>
                        </form>
                    </div>
                </div>
