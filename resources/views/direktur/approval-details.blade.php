        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('leave-approval-director') }}">Persetujuan Cuti</a></div>
                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                            ...
                            <div class="leave-button">
                                <a href="{{ route('leave-approval-director') }}" class="btn btn-light">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
