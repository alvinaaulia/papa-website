        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('profile-hrd') }}">Profil</a></div>
                        ...
                        <div class="card-profile">
                            ...
                            <div class="button-edit">
                                <div class="back-profile" style="margin-bottom: 2rem;">
                                    <a href="{{ route('profile-director') }}">Kembali</a>
                                </div>
                                <div class="edit-profile" style="margin-bottom: 2rem;">
                                    <a href="{{ route('profile-director') }}">Simpan Perubahan</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
