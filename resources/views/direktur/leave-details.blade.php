...
@section('title', 'Rincian Pengajuan Cuti')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Rincian Pengajuan Cuti</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('leave-histories-hrd') }}">Riwayat Cuti</a></div>
                    <div class="breadcrumb-item">Rincian Pengajuan Cuti</div>
                </div>
            </div>
                ...
                <div class="sub-head-leave">
                    <div class="title-leave">
                        ...
                        <div class="sub-lead" style="font-size: 1rem; padding-left: 20px;">
                            Rincian Pengajuan Cuti Karyawan
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-employee">
                                                ...
                                                <input type="text" class="form-control" readonly value="HRD">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-employee">
                            ...
                            <div class="leave-button">
                                <a href="{{ route('leave-list-director') }}" class="btn btn-light">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
