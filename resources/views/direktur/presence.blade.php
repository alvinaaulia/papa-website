...
@section('title', 'Absensi-Direktur')
...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('css/director/presence.css') }}">
    <style>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0 justify-content-between">
                    ...
                    <a href="{{ route('pdf-presence-director') }}" class="btn btn-info me-2" target="_blank"
                        style="width: 120px">
