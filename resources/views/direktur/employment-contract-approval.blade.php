...
@section('title', 'Persetujuan Kontrak Kerja')

@push('style')
    <link rel="stylesheet" href="{{ asset('css/director/employment-contract-approval.css') }}">
@endpush
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-left px-4 pb-3">
                    ...
                    <div class="d-flex flex-column gap-2 w-100" style="margin-top: 35px">
                        <a href="{{ route('view-pdf-employment-contract-director') }}" type="button" class="btn btn-primary btn-sm flex-fill py-2" style="border-radius: 8px"
