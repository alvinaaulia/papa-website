...
@section('title', 'Detail Audit Trail Direktur')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header d-flex justify-content-between align-items-center flex-wrap" style="gap:12px;">
                <div>
                    <h1 class="mb-0">Detail Audit Trail Direktur</h1>
                    <div class="text-muted">Tinjau kondisi sebelum dan sesudah aktivitas dilakukan.</div>
                </div>

                <a href="{{ route('audit-trail-director') }}" class="btn btn-light">
