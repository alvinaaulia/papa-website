                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding: 0px 0px 0px 0px">
                                                    <table class="table table-bordered" style="margin: 0px">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td scope="row" colspan="2" style="padding: 1rem 1.5rem;">
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <div class="overtime-action">
                                                            <button type="button" class="btn btn-warning" onclick="openRevisiModal()">Revisi</button>
                                                            <button type="button" class="btn btn-success" onclick="openApprovedModal()">Setujui</button>
                                                            <button type="button" class="btn btn-danger" onclick="openSuspendModal()">Tangguhkan</button>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <a href="{{ route('approval-details-pm') }}" class="overtime-action"
