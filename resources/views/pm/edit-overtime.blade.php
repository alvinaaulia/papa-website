        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('overtime-histories-pm') }}">Riwayat Lembur</a></div>
                    <div class="breadcrumb-item">Edit Riwayat Lembur</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <form action="#" method="POST">
                                        ...
                                        <div class="overtime-custom" style="padding: 0">
                                            <div class="overtime-time">
                                                ...
                                                <div class="form-group">
                                                    <input type="date" class="form-control" id="tgl-mulai" name="tanggal_mulai" value="2025-09-02">
                                                </div>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="overtime-group">
                                        ...
                                        <textarea class="form-control" name="alasan" style="height: 120px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam id leo at sem vulputate fringilla non nec justo. Nunc et consequat urna. Nam in leo ac sem accumsan porttitor a sed massa. Etiam tempus iaculis lorem sed auctor. In quis egestas nibh. Mauris hendrerit tempor velit</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                            ...
                            <div class="overtime-button">
                                <a href="{{ route('overtime-histories-pm') }}" class="btn btn-light">Kembali</a>
                                <a href="{{ route('overtime-histories-pm') }}" class="btn btn-danger">Simpan Perubahan</a>
                            </div>
                        </form>
                    </div>
                </div>
