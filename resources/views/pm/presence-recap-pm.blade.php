...
@push('style')
    <link rel="stylesheet" href="{{ asset('css/pm/presence-recap.css') }}">
    <style>
        .form-label {
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="presence-recap-pm-title">Laporan Rekap Absensi</h2>
                <p class="presence-recap-pm-subtitle">Laporan rekap absensi kamu</p>
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('pdf-presence-pm') }}" method="GET" target="_blank">
