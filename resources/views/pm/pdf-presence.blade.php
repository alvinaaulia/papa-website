...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pm/pdf-presence.css') }}">
                            ...
                            <div class="presence-container">
                                <div class="presence-header">
                                    ...
                                    <p class="company-address">
                                        Tegal Besar Permai 1, Blk. AB No. 9, Kec. Kaliwates, Kabupaten Jember, Jawa Timur
                                        68132
                                    </p>
                                </div>
                                ...
                                <div class="month-section">
                                    <h3 class="month-title">Bulan : {{ $bulan ?? 'September' }} {{ $tahun ?? '2025' }}</h3>
                                </div>

                                <div class="table-responsive">
                                    <table class="presence-table"
                                        >
                                        <thead style="background-color: #D51C48 !important; color: white !important; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                                            <tr>
                                                <th>Tanggal</th>
                                                <th>Hari</th>
                                                <th>Jam Masuk</th>
