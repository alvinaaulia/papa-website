...
@section('main')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="header-overtime-histories">
                                <h4>Tabel Daftar Lembur Kamu</h4>
                            </div>
                            <div class="card-body">
                                <div class="table">
                                    <table class="table table-bordered">
                                        <thead class="border-custom">
                                            <tr class="overtime-data">
                                                ...
                                                <th class="text-center" style="width: 16%;">Jam Lembur</th>
                                            ...
                                            <tr class="overtime-data">
                                                ...
                                                <td class="text-center">
                                                    <div class="overtime-action space-td">
                                                        <a href="{{ route('edit-overtime-pm') }}" class="overtime-action"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fotoModalLabel">Bukti Lembur</h5>
    ...
    <div class="modal fade" id="trackingStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        aria-hidden="true">
