class PresenceKaryawan {
    constructor() {
        this.baseUrl = '/api/presence-karyawan';
    ...
    /**
     * Dapatkan user ID dari session atau meta tag
     * Sesuaikan dengan cara aplikasi Anda menyimpan user ID
     */
    ...
    handleSuccessResponse(result) {
        ...
        if (result.meta) {
            // Jika backend support pagination
    ...
    /**
     * Generate tombol untuk melihat foto
     */
   ...
   */
    ...
    /**
     * Tambah event listeners untuk pagination
     */
