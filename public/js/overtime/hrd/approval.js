class HrdOvertimeApproval {
    constructor() {
        this.baseListUrl = '/api/hrd/overtimes/approval-list';
        this.approveUrl = (id) => `/api/hrd/overtimes/${id}/approve`;
        this.rejectUrl = (id) => `/api/hrd/overtimes/${id}/reject`;
    ...
    async loadList() {
        try {
            ...
            console.error('Error loading HRD overtime approval list:', error);
